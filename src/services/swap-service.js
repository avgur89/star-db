class SwapiService {
  ...
  IMAGE_BASE_URL = 'https://starwars-visualguide.com/assets/img';
  ...
  getPersonImage = ({ id }) => {
    return `${this.IMAGE_BASE_URL}/characters/${id}.jpg`;
  };

  getStarshipImage = ({ id }) => {
    return `${this.IMAGE_BASE_URL}/starships/${id}.jpg`;
  };

  getPlanetImage = ({ id }) => {
    return `${this.IMAGE_BASE_URL}/planets/${id}.jpg`;
  };
